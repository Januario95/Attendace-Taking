...
class Client:
    ...
    def __connect_with_credentials(self):
        ...
        self.client_.username_pw_set("mesxjhrr", "WmMuCtwRSrsN")
        # self.client_.connect('blithesome-nurse.cloudmqtt.com', 1883, 3600)
        self.client_.connect('wondrous-mechanic.cloudmqtt.com', 1883, 8883)
